...
(function () {
  ...
  /* =========================================================
     GEC 102 MODULE REVIEWER — standalone / non-ranked
     Source: uploaded LSPU GEC 102 SLM, Modules 1.1 and 1.2.
     IMPORTANT: never uses state, saveScore(), Firebase, mastery, or
     leaderboard functions. Designed to be removable as one feature block.
  ========================================================= */
  const GEC102_MODULE_QUESTIONS = [{"m":"1.1","q":"What course does this learning module belong to?","choices":["GEC 102 – Readings in Philippine History","GEC 101 – Understanding the Self","ITEC 102 – Computer Programming","KOMFIL – Komunikasyon"],"answer":"GEC 102 – Readings in Philippine History"},{"m":"1.1","q":"What is the lesson title of Module 1.1?","choices":["History and Historical Research","Content and Contextual Analysis","The Philippine Revolution","Historical Significance"],"answer":"History and Historical Research"},{"m":"1.1","q":"What is the stated duration of Module 1.1?","choices":["2 weeks","1 week","3 weeks","4 weeks"],"answer":"2 weeks"},{"m":"1.1","q":"What is one intended learning outcome of Module 1.1?","choices":["Understand the meaning and relevance of History","Write a research paper using statistics","Create a timeline using software","Memorize all Philippine presidents"],"answer":"Understand the meaning and relevance of History"},{"m":"1.1","q":"What should students be able to evaluate at the end of Module 1.1?","choices":["Primary sources for credibility, authenticity and provenance","Only secondary sources for spelling","Only textbooks for grammar","Social media posts for popularity"],"answer":"Primary sources for credibility, authenticity and provenance"},{"m":"1.1","q":"According to the module, what academic discipline can provide answers by scrutinizing past human events?","choices":["History","Geometry","Physics","Computer Science"],"answer":"History"},{"m":"1.1","q":"Why do we study the past according to the module's discussion?","choices":["To learn about people today and understand present-day phenomena","Only to memorize dates","Only to preserve old buildings","To avoid studying the present"],"answer":"To learn about people today and understand present-day phenomena"},{"m":"1.1","q":"What can examining history help us trace?","choices":["Our roots and identity","Only modern technology","Only economic prices","Only geographic borders"],"answer":"Our roots and identity"},{"m":"1.1","q":"What can lessons from the past help address?","choices":["Problems of today","Only ancient languages","Only future weather","Only personal hobbies"],"answer":"Problems of today"},{"m":"1.1","q":"What does the Greek word Historie or Historia mean?","choices":["Learning, inquiry and/or investigation","War and conquest","Government and law","Writing and printing"],"answer":"Learning, inquiry and/or investigation"},{"m":"1.1","q":"History is described as a branch of what?","choices":["The Social Sciences","Natural Sciences","Engineering","Fine Arts only"],"answer":"The Social Sciences"},{"m":"1.1","q":"What does History systematically study?","choices":["The significant past","Every possible future event","Only mythology","Only current news"],"answer":"The significant past"},{"m":"1.1","q":"What does History record and explain?","choices":["Past events concerning people and human nature","Only scientific experiments","Only fictional stories","Only economic forecasts"],"answer":"Past events concerning people and human nature"},{"m":"1.1","q":"Why does the module emphasize that history is a 'systematic' study?","choices":["It follows a methodology to establish and validate facts and evidence","It studies only mathematical patterns","It avoids using evidence","It relies only on memory"],"answer":"It follows a methodology to establish and validate facts and evidence"},{"m":"1.1","q":"What does 'significant past' refer to?","choices":["Past events that affected political, cultural, social or economic aspects of society or people's lives","Every small action of every person","Only events before writing","Only events involving rulers"],"answer":"Past events that affected political, cultural, social or economic aspects of society or people's lives"},{"m":"1.1","q":"Which example in the module is described as a past event but not Philippine History?","choices":["Juan threw a ball of paper in the trashcan on September 11, 2004","The writing of a historical book","A major political event","A significant cultural development"],"answer":"Juan threw a ball of paper in the trashcan on September 11, 2004"},{"m":"1.1","q":"What does the module say about the conventional definition of history and recorded/written events?","choices":["It commonly covers recorded or written events","It covers only oral traditions","It excludes all documents","It studies only future events"],"answer":"It commonly covers recorded or written events"},{"m":"1.1","q":"What kind of Philippine historical sources can the Western concept fail to account for?","choices":["Unrecorded or unwritten sources such as oral traditions","Only printed textbooks","Only legal documents","Only photographs"],"answer":"Unrecorded or unwritten sources such as oral traditions"},{"m":"1.1","q":"According to E. Kent Rogers, why do we study history in relation to culture?","choices":["To know more about the roots of our current culture","To replace culture with technology","To ignore cultural institutions","To study only foreign cultures"],"answer":"To know more about the roots of our current culture"},{"m":"1.1","q":"How can historical study help explain why Filipinos may value white complexions?","choices":["It can reveal the influence of colonization by Spaniards and Americans on perceptions of status","It proves skin color is historically fixed","It shows that all Filipinos preferred white skin before colonization","It has no connection to history"],"answer":"It can reveal the influence of colonization by Spaniards and Americans on perceptions of status"},{"m":"1.1","q":"How can history help us learn about human nature?","choices":["By looking at trends that repeat through history","By avoiding past events","By studying only geography","By ignoring causes of events"],"answer":"By looking at trends that repeat through history"},{"m":"1.1","q":"How can studying past mistakes help decision-making?","choices":["Negative results can guide us toward a better path","Past mistakes have no relevance","Only positive events matter","It prevents future planning"],"answer":"Negative results can guide us toward a better path"},{"m":"1.1","q":"If a historical result is positive, what does the module say we can recommend?","choices":["Repeat it to get the same result","Forget it immediately","Treat it as irrelevant","Assume it never happened"],"answer":"Repeat it to get the same result"},{"m":"1.1","q":"What is the difference between the past and history?","choices":["The past is everything that happened; history interprets evidence or records from the past","They are exactly the same","History includes only future events","The past is only written documents"],"answer":"The past is everything that happened; history interprets evidence or records from the past"},{"m":"1.1","q":"What does history give to the past?","choices":["Meaning, sense and explanation","Only dates","Only photographs","Only predictions"],"answer":"Meaning, sense and explanation"},{"m":"1.1","q":"What is the main difference between history and prehistory in the module?","choices":["The existence of records","The existence of humans","The existence of cultures","The existence of artifacts only"],"answer":"The existence of records"},{"m":"1.1","q":"What is prehistory?","choices":["The period of human activity before the invention of a writing system","The period after modern technology","The study of future events","The writing of biographies"],"answer":"The period of human activity before the invention of a writing system"},{"m":"1.1","q":"What does the module say about History and other disciplines?","choices":["Methods of studying, writing and teaching history have been modified partly through influence from other disciplines","History has never been influenced by other disciplines","Other disciplines cannot study people","History is completely isolated"],"answer":"Methods of studying, writing and teaching history have been modified partly through influence from other disciplines"},{"m":"1.1","q":"What is History in the distinction among History, Historicity and Historiography?","choices":["A chronology used to study and evaluate past events","Documentation of characters only","The writing of history only","A fictional legend"],"answer":"A chronology used to study and evaluate past events"},{"m":"1.1","q":"What is historicity?","choices":["Documentation of characters in history, as opposed to legend or myth","The study of future predictions","The writing of fiction","The study of economic data"],"answer":"Documentation of characters in history, as opposed to legend or myth"},{"m":"1.1","q":"What is historiography?","choices":["The writing of history and understanding how historians' interpretations change over time","The study of only oral traditions","The study of geography","The collection of artifacts only"],"answer":"The writing of history and understanding how historians' interpretations change over time"},{"m":"1.1","q":"What does 'herstory' mean in the module?","choices":["History written from a feminist perspective emphasizing women's roles or a woman's point of view","A history of computers","A type of archaeology","A chronology of wars only"],"answer":"History written from a feminist perspective emphasizing women's roles or a woman's point of view"},{"m":"1.1","q":"What does Historical Research consist of?","choices":["Techniques and guidelines historians use to research and write histories using primary sources and other evidence","Only memorization techniques","Only interviews with living people","Only textbook reading"],"answer":"Techniques and guidelines historians use to research and write histories using primary sources and other evidence"},{"m":"1.1","q":"What can historical research encompass as evidence?","choices":["Data of archaeology and other evidence","Only fictional stories","Only social media","Only future predictions"],"answer":"Data of archaeology and other evidence"},{"m":"1.1","q":"What is the main purpose of Historical Research?","choices":["To illustrate and assess past events, acknowledge the present, and anticipate possible future effects","To remove evidence from history","To study only current events","To predict the future with certainty"],"answer":"To illustrate and assess past events, acknowledge the present, and anticipate possible future effects"},{"m":"1.1","q":"Why are histories dominant according to the module?","choices":["They produce and strengthen collective identities","They eliminate collective memory","They avoid identity questions","They focus only on individual hobbies"],"answer":"They produce and strengthen collective identities"},{"m":"1.1","q":"How is history compared to collective memory?","choices":["Historians produce a collective memory about the past","History is unrelated to memory","Memory is always fictional","Only families can produce history"],"answer":"Historians produce a collective memory about the past"},{"m":"1.1","q":"What did the Greeks think about historical events in the cyclical view?","choices":["Events recurred on a regular basis","Events moved only forward","Events never repeated","Events were controlled completely by one ruler"],"answer":"Events recurred on a regular basis"},{"m":"1.1","q":"How did Herodotus view history according to the module?","choices":["As a story of men and states as recurring cycles","As a purely linear process","As a scientific experiment","As a record of only women"],"answer":"As a story of men and states as recurring cycles"},{"m":"1.1","q":"How did Thucydides envision time?","choices":["As recurring in a cyclical fashion that men are unable to control","As a straight line with no repetition","As completely random without patterns","As controlled by historians"],"answer":"As recurring in a cyclical fashion that men are unable to control"},{"m":"1.1","q":"Who revived the cyclical concept of history in the 14th century?","choices":["Petrarch","Plato","Hitler","Winston Churchill"],"answer":"Petrarch"},{"m":"1.1","q":"How did Machiavelli see history?","choices":["As cyclical and as a casebook of political strategy","As a collection of myths only","As a linear scientific formula","As unrelated to politics"],"answer":"As cyclical and as a casebook of political strategy"},{"m":"1.1","q":"What premise did Arnold Toynbee and Oswald Spengler use?","choices":["History is cyclical; civilizations rise and fall","History is entirely random","History is only linear","History has no civilizations"],"answer":"History is cyclical; civilizations rise and fall"},{"m":"1.1","q":"What does the Linear View of History imply?","choices":["Linear time; history progresses forward without cyclical return","Events repeat exactly","History has no direction","History is only mythology"],"answer":"Linear time; history progresses forward without cyclical return"},{"m":"1.1","q":"What does the Great God View of History discuss in the module?","choices":["Myths describing the origin and improvement of the world and humans, including the Genesis account","The rise of political parties","The study of gender","The writing of biographies"],"answer":"Myths describing the origin and improvement of the world and humans, including the Genesis account"},{"m":"1.1","q":"What does the Great Man View of History suggest?","choices":["Dominant personalities determine the course of history","Only ordinary people determine history","Ideas have no influence","History is completely cyclical"],"answer":"Dominant personalities determine the course of history"},{"m":"1.1","q":"Who are examples of decisive forces named under the Great Man View?","choices":["Rulers, warriors and statesmen","Teachers, artists and students only","Farmers, merchants and scientists only","Historians only"],"answer":"Rulers, warriors and statesmen"},{"m":"1.1","q":"What does the Best People View of History claim?","choices":["An elite, best race, favored nation or ruling class alone makes history","Everyone has equal historical influence in every situation","Only ideas make history","History has no social dimension"],"answer":"An elite, best race, favored nation or ruling class alone makes history"},{"m":"1.1","q":"What is the Ideas or Great Mind View of History?","choices":["The driving force in history is people's ideas","The driving force is only geography","The driving force is only rulers","The driving force is only artifacts"],"answer":"The driving force in history is people's ideas"},{"m":"1.1","q":"What does the Human Nature View of History emphasize?","choices":["History is determined by qualities of human nature, good or bad","History is determined only by technology","Human nature changes completely every day","History has no relation to people"],"answer":"History is determined by qualities of human nature, good or bad"},{"m":"1.1","q":"What does Gender History examine?","choices":["The past from the perspective of gender and how events affect women and men differently","Only the history of wars","Only economic statistics","Only rulers' biographies"],"answer":"The past from the perspective of gender and how events affect women and men differently"},{"m":"1.1","q":"What does the Post Modern View of History in the module say?","choices":["The radical Postmodernist sees no ultimate purpose in history","History always follows a divine plan","History always repeats","Only rulers create history"],"answer":"The radical Postmodernist sees no ultimate purpose in history"},{"m":"1.1","q":"What is a primary source?","choices":["Information created or narrated by participants or eyewitnesses during or nearly after an event, giving direct first-hand information","A material written only to summarize textbooks","A source that is always fictional","A source created centuries later with no relation to an event"],"answer":"Information created or narrated by participants or eyewitnesses during or nearly after an event, giving direct first-hand information"},{"m":"1.1","q":"Which is an example of a primary source listed in the module?","choices":["Eyewitness account","Textbook","Summary","Biography written by another author"],"answer":"Eyewitness account"},{"m":"1.1","q":"Which of the following is also listed as a primary source?","choices":["Diary","Textbook","Review","Commentary"],"answer":"Diary"},{"m":"1.1","q":"Which is an example of a primary source involving visual material?","choices":["Photograph","Textbook summary","Biography","Essay about a photograph"],"answer":"Photograph"},{"m":"1.1","q":"Which is an example of a primary source involving creative writing?","choices":["Song or poetry","Textbook","Review","Commentary"],"answer":"Song or poetry"},{"m":"1.1","q":"What is a secondary source?","choices":["Material written to interpret, discuss, analyze and comment on a primary source","A first-hand eyewitness account","An artifact made during an event","An original diary"],"answer":"Material written to interpret, discuss, analyze and comment on a primary source"},{"m":"1.1","q":"Which is a secondary source example listed in the module?","choices":["Textbook","Diary","Autobiography","Original photograph"],"answer":"Textbook"},{"m":"1.1","q":"Which of these is listed as a secondary source?","choices":["Biography","Eyewitness account","Artifact","Letter"],"answer":"Biography"},{"m":"1.1","q":"What source category is listed after Secondary Sources in Module 1.1?","choices":["Tertiary Sources","Primary Sources","Oral Sources","Visual Sources"],"answer":"Tertiary Sources"},{"m":"1.1","q":"What does external criticism examine?","choices":["The genuineness of the documents used in a historical study","The accuracy of what a document says","The author's emotions only","The number of pages"],"answer":"The genuineness of the documents used in a historical study"},{"m":"1.1","q":"What does internal criticism examine?","choices":["The accuracy of the contents of documents","The physical genuineness of a document only","The paper's color","The author's handwriting only"],"answer":"The accuracy of the contents of documents"},{"m":"1.1","q":"External criticism is mainly concerned with what?","choices":["Authenticity or genuineness of a document","The meaning of a sentence only","The emotional reaction of readers","The number of readers"],"answer":"Authenticity or genuineness of a document"},{"m":"1.1","q":"Internal criticism is mainly concerned with what?","choices":["What the document says and the accuracy of its contents","Whether the document physically exists","The age of the paper only","The location of a library"],"answer":"What the document says and the accuracy of its contents"},{"m":"1.1","q":"In the performance task, an old photograph of a woman from 1861 is what type of source?","choices":["Primary","Secondary","Tertiary","Not a source"],"answer":"Primary"},{"m":"1.1","q":"In the performance task, the biography of Edgar Jopson using interviews and primary documents is classified as what?","choices":["Secondary","Primary","Tertiary","Oral source"],"answer":"Secondary"},{"m":"1.1","q":"In the performance task, a textbook whose authors used works by known historians is what type?","choices":["Secondary","Primary","Tertiary","Artifact"],"answer":"Secondary"},{"m":"1.1","q":"In the performance task, the Golden Tara sculpture is what type of source?","choices":["Primary","Secondary","Tertiary","Textbook"],"answer":"Primary"},{"m":"1.1","q":"In the performance task, a provincial tourism travel brochure containing researched historical information is what type?","choices":["Tertiary","Primary","Secondary","Eyewitness"],"answer":"Tertiary"},{"m":"1.1","q":"What does PT2 ask students to differentiate?","choices":["History from other humanistic or social scientific disciplines","Primary from secondary sources only","Past from future","Myth from legend only"],"answer":"History from other humanistic or social scientific disciplines"},{"m":"1.1","q":"What is the word limit for the PT2 essay?","choices":["Not exceeding 200 words","Not exceeding 500 words","Not exceeding 1,000 words","Exactly 50 words"],"answer":"Not exceeding 200 words"},{"m":"1.1","q":"How many paragraphs are suggested for PT2?","choices":["1–2 paragraphs","3–4 paragraphs","5 paragraphs","10 paragraphs"],"answer":"1–2 paragraphs"},{"m":"1.1","q":"What can the first paragraph of PT2 include?","choices":["The subject being compared and reasons for comparison","Only a bibliography","Only a conclusion","Only a title"],"answer":"The subject being compared and reasons for comparison"},{"m":"1.1","q":"What can the second paragraph of PT2 include?","choices":["Conclusions","Only quotations","Only definitions","Only questions"],"answer":"Conclusions"},{"m":"1.2","q":"What is the lesson title of Module 1.2?","choices":["Content and Contextual Analysis, Identification of the Historical Importance of the Text and Examination of the Author’s Main Argument and Point of View","History and Historical Research","Sources of Philippine History","Theories of History"],"answer":"Content and Contextual Analysis, Identification of the Historical Importance of the Text and Examination of the Author’s Main Argument and Point of View"},{"m":"1.2","q":"What is the duration of Module 1.2?","choices":["2 weeks","1 week","3 weeks","4 weeks"],"answer":"2 weeks"},{"m":"1.2","q":"What is one intended learning outcome of Module 1.2?","choices":["Understand the Template Rating about Event’s Significance","Memorize all historical dates","Write computer programs","Identify all Philippine presidents"],"answer":"Understand the Template Rating about Event’s Significance"},{"m":"1.2","q":"What author-related skill is included among the intended learning outcomes?","choices":["Identify the Author’s Purpose","Identify the author's home address","Identify the author's favorite color","Identify the author's handwriting speed"],"answer":"Identify the Author’s Purpose"},{"m":"1.2","q":"What should students identify about a text?","choices":["Its historical importance","Its future price","Its file size","Its page color"],"answer":"Its historical importance"},{"m":"1.2","q":"What should students be able to analyze according to the objectives?","choices":["The context, content and perspective of different kinds of primary sources","Only secondary sources","Only photographs","Only modern news"],"answer":"The context, content and perspective of different kinds of primary sources"},{"m":"1.2","q":"What should students determine about different kinds of primary sources?","choices":["Their contribution to understanding Philippine History","Their selling price","Their file format","Their popularity online"],"answer":"Their contribution to understanding Philippine History"},{"m":"1.2","q":"What skills should exposure to primary sources help develop?","choices":["Critical and analytical skills","Only typing speed","Only drawing skills","Only memorization speed"],"answer":"Critical and analytical skills"},{"m":"1.2","q":"When analyzing a primary source, what do we start with?","choices":["Content and context","Conclusion and bibliography","Date and price","Author and publisher only"],"answer":"Content and context"},{"m":"1.2","q":"What should be identified when analyzing a primary source?","choices":["Author, audience and historical context","Only title and page number","Only location and price","Only font and paper size"],"answer":"Author, audience and historical context"},{"m":"1.2","q":"Why should we understand the attitudes and influences that prompted a source's creation?","choices":["To avoid misinterpreting its true meaning","To make the source longer","To remove its context","To change its author"],"answer":"To avoid misinterpreting its true meaning"},{"m":"1.2","q":"What is Content Analysis?","choices":["A research method for studying documents and communication artifacts","A method for predicting future events","A method for measuring paper thickness","A method for ranking historians"],"answer":"A research method for studying documents and communication artifacts"},{"m":"1.2","q":"What formats can content analysis study according to the module?","choices":["Texts, pictures, audio or video","Only books","Only speeches","Only photographs"],"answer":"Texts, pictures, audio or video"},{"m":"1.2","q":"According to the module, what question does content analysis ask about the period a material was written?","choices":["What was going on during that period?","Who bought the material?","How expensive was the material?","How many pages did it have?"],"answer":"What was going on during that period?"},{"m":"1.2","q":"What does content analysis search for to explain facts found in a source?","choices":["Background information","Future predictions","Unrelated advertisements","Personal passwords"],"answer":"Background information"},{"m":"1.2","q":"According to Klaus Krippendorff, how many items must be addressed in every content analysis?","choices":["Six","Three","Five","Ten"],"answer":"Six"},{"m":"1.2","q":"In Krippendorff’s list, what is the first item to address?","choices":["Which data are analyzed?","Who owns the document?","How old is the reader?","What is the author's favorite topic?"],"answer":"Which data are analyzed?"},{"m":"1.2","q":"What is the second item in Krippendorff’s six questions?","choices":["How are the data defined?","Where was the author born?","Who printed the text?","How many readers liked it?"],"answer":"How are the data defined?"},{"m":"1.2","q":"What is the third item in Krippendorff’s six questions?","choices":["From what population is data drawn?","What is the document's color?","Who translated it?","What is the author's age?"],"answer":"From what population is data drawn?"},{"m":"1.2","q":"What is the fourth item in Krippendorff’s six questions?","choices":["What is the relevant context?","What is the paper size?","Who owns the library?","What is the title font?"],"answer":"What is the relevant context?"},{"m":"1.2","q":"What is the fifth item in Krippendorff’s six questions?","choices":["What are the boundaries of the Analysis?","How many chapters are there?","What is the author's salary?","Where is the textbook sold?"],"answer":"What are the boundaries of the Analysis?"},{"m":"1.2","q":"What is the sixth item in Krippendorff’s six questions?","choices":["What is to be measured?","Who wrote the bibliography?","What is the book's price?","When was the reader born?"],"answer":"What is to be measured?"},{"m":"1.2","q":"How many types of texts are listed for content analysis?","choices":["Five","Two","Three","Seven"],"answer":"Five"},{"m":"1.2","q":"What is a written text?","choices":["Books and papers","Speech and theatrical performance","Drawings and paintings","TV programs and videos"],"answer":"Books and papers"},{"m":"1.2","q":"What is an oral text?","choices":["Speech or theatrical performance","Books and papers","Drawings and icons","Internet text"],"answer":"Speech or theatrical performance"},{"m":"1.2","q":"What is an iconic text?","choices":["Drawings, paintings and icons","Books and papers","Speeches","TV programs"],"answer":"Drawings, paintings and icons"},{"m":"1.2","q":"What is an audio-visual text?","choices":["TV programs, movies and videos","Books and papers","Drawings and paintings","Internet-only text"],"answer":"TV programs, movies and videos"},{"m":"1.2","q":"What are hypertexts?","choices":["Text found on the Internet","Text in handwritten diaries only","Paintings and icons","Theatrical performances"],"answer":"Text found on the Internet"},{"m":"1.2","q":"What are the two types of Content Analysis named in the module?","choices":["Conceptual Analysis and Relational Analysis","Internal and External Criticism","Linear and Cyclical Analysis","Primary and Secondary Analysis"],"answer":"Conceptual Analysis and Relational Analysis"},{"m":"1.2","q":"What does Conceptual Analysis help establish?","choices":["The existence and frequency of concepts in the text","The author's exact income","The age of the paper","The number of images in a website"],"answer":"The existence and frequency of concepts in the text"},{"m":"1.2","q":"What does Relational Analysis examine?","choices":["The relationship among concepts in the text","The physical authenticity of paper","The author's biography only","The number of pages"],"answer":"The relationship among concepts in the text"},{"m":"1.2","q":"What is Contextual Analysis?","choices":["Analysis that assesses a text within its historical and cultural setting and its textual qualities","Analysis of only grammar","Analysis of only paper quality","Analysis of future events"],"answer":"Analysis that assesses a text within its historical and cultural setting and its textual qualities"},{"m":"1.2","q":"What does contextual analysis combine?","choices":["Formal analysis with elements of cultural archaeology","Statistics with programming","Biography with fiction","Geology with mathematics"],"answer":"Formal analysis with elements of cultural archaeology"},{"m":"1.2","q":"What does cultural archaeology systematically study in this module?","choices":["Social, political, economic, philosophical, religious and aesthetic conditions","Only buildings","Only artifacts","Only written laws"],"answer":"Social, political, economic, philosophical, religious and aesthetic conditions"},{"m":"1.2","q":"What is one key contextual-analysis question about the text itself?","choices":["What does the text reveal about itself as a text?","How much does the text cost?","Who owns the computer?","How many people downloaded it?"],"answer":"What does the text reveal about itself as a text?"},{"m":"1.2","q":"What does the question about language and arrangement of words examine?","choices":["The text as a text","The author's salary","The document's price","The reader's age"],"answer":"The text as a text"},{"m":"1.2","q":"What should contextual analysis ask about the intended audience?","choices":["What does the text tell us about its apparent intended audience?","What is the audience's favorite subject?","Where does the audience live today?","How much did the audience pay?"],"answer":"What does the text tell us about its apparent intended audience?"},{"m":"1.2","q":"What should contextual analysis ask about the author's intention?","choices":["What seems to have been the author’s intention?","What is the author's phone number?","What is the author's favorite book?","What is the author's handwriting style?"],"answer":"What seems to have been the author’s intention?"},{"m":"1.2","q":"What clues can reveal the author's intention?","choices":["What the author said/did not say and how the author said it","Only the title","Only the number of pages","Only the publication price"],"answer":"What the author said/did not say and how the author said it"},{"m":"1.2","q":"What should be asked about the occasion for a text?","choices":["What is the occasion for this text?","What is the paper weight?","What is the author's salary?","How many copies were sold?"],"answer":"What is the occasion for this text?"},{"m":"1.2","q":"What does the occasion refer to in the module?","choices":["A particular event or the author’s general observation about it","Only the publication date","Only the author's birthday","Only a library event"],"answer":"A particular event or the author’s general observation about it"},{"m":"1.2","q":"What question checks whether a text is a call for action?","choices":["Is the text intended as some sort of call to or for action?","Is the text expensive?","Is the text handwritten?","Is the text illustrated?"],"answer":"Is the text intended as some sort of call to or for action?"},{"m":"1.2","q":"What non-textual circumstances can affect a text's creation and reception?","choices":["Political events, economic factors, cultural practices, intellectual/aesthetic issues and circumstances of the author's life","Only the weather","Only paper quality","Only the reader's age"],"answer":"Political events, economic factors, cultural practices, intellectual/aesthetic issues and circumstances of the author's life"},{"m":"1.2","q":"What is the subtext of a document or object?","choices":["Its secondary and implied meanings","Its title only","Its bibliography","Its page number"],"answer":"Its secondary and implied meanings"},{"m":"1.2","q":"What does subtext embrace?","choices":["Emotional or intellectual messages embedded in or indicated by the document or text","Only spelling errors","Only dates","Only illustrations"],"answer":"Emotional or intellectual messages embedded in or indicated by the document or text"},{"m":"1.2","q":"What is historical significance?","choices":["The process used to evaluate the importance of selected events, people and developments in the past","A list of all dates in history","A method of writing fiction","A way to rank textbooks"],"answer":"The process used to evaluate the importance of selected events, people and developments in the past"},{"m":"1.2","q":"What distinction does the module say is important to understanding significance?","choices":["The distinction between teaching significant history and asking students to judge significance","The distinction between books and papers","The distinction between authors and readers","The distinction between past and future"],"answer":"The distinction between teaching significant history and asking students to judge significance"},{"m":"1.2","q":"What does the criterion RELEVANCE ask?","choices":["Is it necessary/relevant to people living in the time, and is it still relevant to present lives?","Was it expensive?","Was it written in English?","Was it popular online?"],"answer":"Is it necessary/relevant to people living in the time, and is it still relevant to present lives?"},{"m":"1.2","q":"What does RESONANCE consider?","choices":["Who was affected, how lives were affected, and whether connections can be made across time and place","Only the number of pages","Only the author's purpose","Only the date"],"answer":"Who was affected, how lives were affected, and whether connections can be made across time and place"},{"m":"1.2","q":"What does REMARKABLE ask?","choices":["Was the event remarked on by people at the time or since?","Was it written by a famous person?","Was it published online?","Was it very long?"],"answer":"Was the event remarked on by people at the time or since?"},{"m":"1.2","q":"What does REMEMBERED ask?","choices":["Was the event/development significant at some stage within the collective memory of a group or groups?","Was it remembered by one student?","Was it written in a diary?","Was it stored in a museum?"],"answer":"Was the event/development significant at some stage within the collective memory of a group or groups?"},{"m":"1.2","q":"What does REVEALING ask?","choices":["Does it reveal some other aspects of the past?","Does it predict the future?","Does it entertain readers?","Does it sell products?"],"answer":"Does it reveal some other aspects of the past?"},{"m":"1.2","q":"What does RESULTING IN CHANGE ask?","choices":["Does it have consequences for the future?","Did it have many pages?","Did it use formal language?","Was it written by a ruler?"],"answer":"Does it have consequences for the future?"},{"m":"1.2","q":"What does DURABILITY consider?","choices":["How long people's lives have been affected","How long the document is","How long the author lived","How long the event was described"],"answer":"How long people's lives have been affected"},{"m":"1.2","q":"What does QUANTITY consider?","choices":["How many people were affected and the scale of the affected group","How many pages were written","How many authors contributed","How many photographs were used"],"answer":"How many people were affected and the scale of the affected group"},{"m":"1.2","q":"What does PROFUNDITY consider?","choices":["Whether the event was superficial or deeply affecting and how deeply lives were affected","How many years ago it happened","Whether the text was long","Whether the author was famous"],"answer":"Whether the event was superficial or deeply affecting and how deeply lives were affected"},{"m":"1.2","q":"What does the module say about the author's purpose?","choices":["It is not always clear and is reflected in how the author writes about the topic","It is always stated in the first sentence","It can never be identified","It is determined only by the title"],"answer":"It is not always clear and is reflected in how the author writes about the topic"},{"m":"1.2","q":"What is the purpose 'to Persuade'?","choices":["The author wants you to believe, do or buy something","The author wants only to entertain","The author wants to list facts","The author wants to describe appearance"],"answer":"The author wants you to believe, do or buy something"},{"m":"1.2","q":"What type of writing is associated with 'to Persuade'?","choices":["Persuasive writing","Narrative writing","Descriptive writing","Creative writing only"],"answer":"Persuasive writing"},{"m":"1.2","q":"Which is an example of writing meant to persuade?","choices":["Campaign speeches","Encyclopaedias","Instructions","History texts"],"answer":"Campaign speeches"},{"m":"1.2","q":"What is the purpose 'to Inform'?","choices":["The author wants to give information or instructions","The author wants to amuse readers","The author wants to visualize an object","The author wants to tell a past story only"],"answer":"The author wants to give information or instructions"},{"m":"1.2","q":"What type of writing is associated with 'to Inform'?","choices":["Expository writing","Narrative writing","Descriptive writing","Creative writing"],"answer":"Expository writing"},{"m":"1.2","q":"Which is an example of writing meant to inform?","choices":["Textbooks","Songs","Poems","Novels"],"answer":"Textbooks"},{"m":"1.2","q":"What is the purpose 'to Narrate or Recount'?","choices":["The author wants to relate a story or recount past events","The author wants to persuade readers to buy something","The author wants to define a word","The author wants to visualize a scene"],"answer":"The author wants to relate a story or recount past events"},{"m":"1.2","q":"What type of writing is associated with narration or recounting?","choices":["Narrative writing","Expository writing","Descriptive writing","Persuasive writing"],"answer":"Narrative writing"},{"m":"1.2","q":"Which is an example of narrative writing listed in the module?","choices":["Biographies","Contracts","Instructions","Advertisements"],"answer":"Biographies"},{"m":"1.2","q":"What is the purpose 'to Describe'?","choices":["The author wants you to visualize or experience what something looks like, sounds like or feels like","The author wants to prove an argument","The author wants to list facts","The author wants to give instructions"],"answer":"The author wants you to visualize or experience what something looks like, sounds like or feels like"},{"m":"1.2","q":"Which is an example of descriptive writing listed in the module?","choices":["Poems","Contracts","Textbooks","Campaign speeches"],"answer":"Poems"},{"m":"1.2","q":"What is the purpose 'to Explain'?","choices":["The author wants to tell you how to do something or how something works","The author wants to amuse you","The author wants to persuade you","The author wants to narrate a biography"],"answer":"The author wants to tell you how to do something or how something works"},{"m":"1.2","q":"What type of writing does 'to Explain' fall under in the module?","choices":["Expository essay","Narrative writing","Descriptive writing","Creative writing"],"answer":"Expository essay"},{"m":"1.2","q":"Which is an example of explanatory writing?","choices":["Operations manual","Novel","Song","Poem"],"answer":"Operations manual"},{"m":"1.2","q":"What is the purpose 'to Entertain'?","choices":["The author wants to amuse you or for you to enjoy the writing itself","The author wants to give instructions","The author wants to provide a contract","The author wants to analyze a document"],"answer":"The author wants to amuse you or for you to enjoy the writing itself"},{"m":"1.2","q":"What type of writing is associated with 'to Entertain'?","choices":["Creative writing","Expository writing","Narrative writing","Persuasive writing"],"answer":"Creative writing"},{"m":"1.2","q":"Which is an example of writing meant to entertain?","choices":["Novels","Contracts","Directions","Business letters"],"answer":"Novels"},{"m":"1.2","q":"What is the first step in identifying an author's purpose?","choices":["Ask, 'Why did the author create/write this text?'","Count the pages","Check the paper color","Find the author's address"],"answer":"Ask, 'Why did the author create/write this text?'"},{"m":"1.2","q":"If the author's purpose is not obvious, what question does the module suggest?","choices":["How did this make me feel?","How much did this cost?","Who printed it?","How many pages are there?"],"answer":"How did this make me feel?"},{"m":"1.2","q":"What should you look for to identify an author's purpose?","choices":["Clue words","Only photographs","Only the bibliography","Only the title"],"answer":"Clue words"},{"m":"1.2","q":"What does the clue-word category 'Compare' indicate?","choices":["The author wants to show similarities between ideas","The author wants to show differences","The author wants to criticize","The author wants to propose an idea"],"answer":"The author wants to show similarities between ideas"},{"m":"1.2","q":"Which words are examples of Compare clue words?","choices":["Both, similarly, in the same way, like, just as","However, but, on the other hand","Judgment words","Superlative adjectives"],"answer":"Both, similarly, in the same way, like, just as"},{"m":"1.2","q":"What does the clue-word category 'Contrast' indicate?","choices":["The author wants to show differences between ideas","The author wants to show similarities","The author wants to list ideas","The author wants to entertain"],"answer":"The author wants to show differences between ideas"},{"m":"1.2","q":"Which are examples of Contrast clue words?","choices":["However, but, dissimilarly, on the other hand","Both, similarly, like","Adjectives only","Superlative adjectives only"],"answer":"However, but, dissimilarly, on the other hand"},{"m":"1.2","q":"What does 'Criticize' indicate?","choices":["The author wants to give a negative opinion about an idea","The author wants to compare ideas","The author wants to describe an object","The author wants to list facts"],"answer":"The author wants to give a negative opinion about an idea"},{"m":"1.2","q":"What does 'Describe/Illustrate' indicate?","choices":["The author wants to paint a picture of an idea","The author wants to prove a point","The author wants to show differences","The author wants to list ideas"],"answer":"The author wants to paint a picture of an idea"},{"m":"1.2","q":"What kind of clue words are associated with Describe/Illustrate?","choices":["Adjectives","Superlative adjectives only","Contrast words","Compare words"],"answer":"Adjectives"},{"m":"1.2","q":"What does 'Explain' indicate as an author's purpose clue?","choices":["The author wants to break down an idea into simpler terms","The author wants to criticize an idea","The author wants to compare ideas","The author wants to entertain"],"answer":"The author wants to break down an idea into simpler terms"},{"m":"1.2","q":"What does 'Identify/List' indicate?","choices":["The author wants to tell the reader about an idea or series of ideas","The author wants to give a negative opinion","The author wants to intensify an idea","The author wants to suggest an idea"],"answer":"The author wants to tell the reader about an idea or series of ideas"},{"m":"1.2","q":"What does identifying/listing usually do according to the module?","choices":["Names an idea or series of ideas without much description or opinion","Uses many adjectives","Shows similarities","Proposes a new idea"],"answer":"Names an idea or series of ideas without much description or opinion"},{"m":"1.2","q":"What does 'Intensify' indicate?","choices":["The author wants to make an idea greater","The author wants to show differences","The author wants to list ideas","The author wants to describe a setting"],"answer":"The author wants to make an idea greater"},{"m":"1.2","q":"What clue may signal Intensify?","choices":["Additional details to the idea or superlative adjectives","However and but","Both and similarly","Only nouns"],"answer":"Additional details to the idea or superlative adjectives"},{"m":"1.2","q":"What does 'Suggest' indicate?","choices":["The author wants to propose an idea","The author wants to criticize an idea","The author wants to recount an event","The author wants to describe a picture"],"answer":"The author wants to propose an idea"},{"m":"1.2","q":"What kind of clues are associated with Suggest?","choices":["Positive opinions and proving of a point","Negative judgment words","Contrast words","Only adjectives"],"answer":"Positive opinions and proving of a point"},{"m":"1.2","q":"In the Module 1.2 performance task, what must students provide?","choices":["A piece of Philippine History with historical significance aligned with a criterion for assessing a source","A biography of the instructor","A computer program","A list of textbooks"],"answer":"A piece of Philippine History with historical significance aligned with a criterion for assessing a source"},{"m":"1.2","q":"What criterion is used in the example performance task?","choices":["Revealing","Quantity","Durability","Profundity"],"answer":"Revealing"},{"m":"1.2","q":"What historical figure appears in the module's example for the Revealing criterion?","choices":["Ninoy Aquino","Jose Rizal","Emilio Aguinaldo","Andres Bonifacio"],"answer":"Ninoy Aquino"},{"m":"1.2","q":"According to the module's example, what did the interview reveal about Ninoy Aquino?","choices":["He knew that his life would be in danger once he got off the airplane's tarmac","He planned to leave Manila permanently","He became president","He wrote a textbook"],"answer":"He knew that his life would be in danger once he got off the airplane's tarmac"},{"m":"1.2","q":"What second criterion is explicitly listed for the Module 1.2 performance task?","choices":["Resonance","Relevance","Durability","Quantity"],"answer":"Resonance"}];

  const gecModuleReviewer = {
    activeModule: "1.1",
    questions: [],
    index: 0,
    correct: 0,
    ...
    open() {
      const overlay = $("gecModuleReviewerOverlay");
      if (!overlay) return;
      overlay.hidden = false;
      document.body.classList.add("no-scroll");
      this.selectModule("1.1");
    },
    ...
    selectModule(moduleId) {
      ...
      const tabs = document.querySelectorAll(".gec-module-tab");
      tabs.forEach((tab) => {
        const selected = tab.dataset.gecModule === moduleId;
        tab.classList.toggle("selected", selected);
        tab.setAttribute("aria-selected", selected ? "true" : "false");
      });

      const source = moduleId === "both"
        ? GEC102_MODULE_QUESTIONS.slice()
        : GEC102_MODULE_QUESTIONS.filter((item) => item.m === moduleId);

      this.questions = source.slice();
      this.index = 0;
      this.correct = 0;
      this.answered = false;
      this.shuffled = shuffle(this.questions.slice());
      this.renderQuestion();
    },

    renderQuestion() {
      const host = $("gecModuleReviewBody");
      if (!host) return;

      if (this.index >= this.shuffled.length) {
        const total = this.shuffled.length;
        const pct = total ? Math.round((this.correct / total) * 100) : 0;
        const label = this.activeModule === "both" ? "Modules 1.1 + 1.2" : `Module ${this.activeModule}`;
        host.innerHTML = `
          <div class="gec-module-summary">
            <div class="gec-module-label">${escapeHtml(label)}</div>
            <h4>Review complete</h4>
            <p><strong>${this.correct} / ${total}</strong> correct · ${pct}%</p>
            <p>This result is only for this study session. It is <strong>not</strong> sent to Firebase, mastery, or any leaderboard.</p>
            <div class="gec-module-actions">
              <button type="button" class="gec-module-next" id="gecModuleRestartBtn">↻ REVIEW AGAIN</button>
            </div>
          </div>`;
        const restart = $("gecModuleRestartBtn");
        if (restart) bindTap(restart, (e) => {
          e.preventDefault();
      ...
      const item = this.shuffled[this.index];
      const options = shuffle(item.choices.slice());
      this.answered = false;

      host.innerHTML = `
        <div class="gec-module-progress">
          <span>Question ${this.index + 1} of ${this.shuffled.length}</span>
          <span>Correct: ${this.correct}</span>
        </div>
        <div class="gec-module-bar" aria-hidden="true"><span style="width:${Math.round((this.index / this.shuffled.length) * 100)}%"></span></div>
        <div class="gec-module-card">
          <div class="gec-module-label">GEC 102 · Module ${escapeHtml(item.m)}</div>
          <div class="gec-module-question">${escapeHtml(item.q)}</div>
          <div class="gec-module-choices" id="gecModuleChoices"></div>
          <div class="gec-module-feedback" id="gecModuleFeedback" aria-live="polite"></div>
          <button type="button" class="gec-module-next" id="gecModuleNextBtn" disabled>NEXT QUESTION →</button>
        </div>`;

      const choicesHost = $("gecModuleChoices");
      options.forEach((choice) => {
        const btn = document.createElement("button");
        btn.type = "button";
        btn.className = "gec-module-choice";
      ...
      const next = $("gecModuleNextBtn");
      if (next) bindTap(next, (e) => {
        e.preventDefault();
    ...
    answer(choice) {
      ...
      const buttons = document.querySelectorAll("#gecModuleChoices .gec-module-choice");
      buttons.forEach((btn) => {
        btn.disabled = true;
        if (btn.textContent === item.answer) btn.classList.add("correct");
        if (btn.textContent === choice && choice !== item.answer) btn.classList.add("wrong");
      });

      const feedback = $("gecModuleFeedback");
      if (choice === item.answer) {
        this.correct += 1;
        if (feedback) feedback.innerHTML = "✓ <strong>Correct.</strong> " + escapeHtml(item.answer);
      } else {
        if (feedback) feedback.innerHTML = "✗ <strong>Review this:</strong> " + escapeHtml(item.answer);
      }

      const next = $("gecModuleNextBtn");
      if (next) next.disabled = false;

      const progress = document.querySelector(".gec-module-progress span:last-child");
      if (progress) progress.textContent = `Correct: ${this.correct}`;
    }
  };

  function initGecModuleReviewer() {
    const openBtn = $("openGecModuleReviewerBtn");
    const closeBtn = $("closeGecModuleReviewerBtn");
    const overlay = $("gecModuleReviewerOverlay");

    if (openBtn) bindTap(openBtn, (e) => {
      e.preventDefault();
      gecModuleReviewer.open();
    });
    if (closeBtn) bindTap(closeBtn, (e) => {
      e.preventDefault();
      gecModuleReviewer.close();
    });
    if (overlay) bindTap(overlay, (e) => {
      if (e.target === overlay) gecModuleReviewer.close();
    });

    document.querySelectorAll(".gec-module-tab").forEach((tab) => {
      bindTap(tab, (e) => {
        e.preventDefault();
        gecModuleReviewer.selectModule(tab.dataset.gecModule || "1.1");
      });
    });
  }
